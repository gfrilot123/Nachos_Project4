...
//Code changes begins by Robert Knott
//------------------------------------------------------------------------
//List::PrintList
...
void List::PrintList()
{
    ListElement *dummy = new ListElement(0, NULL);

    if (IsEmpty())
    {		// list is empty
	printf("The list has yet to be made.\n");
	return;
    }
    else
    {		//there is something to be read in the list
...
//Code changes ends by Robert Knott
